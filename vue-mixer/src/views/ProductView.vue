                        ...
                        <div class="row">
                            ...
                            <div class="desc1-right col-md-6 pl-lg-4">
                                ...
                                <ul>
                                    ...
                                    <li class="li-product"><span><b>Слоган:</b> «Welcome to the Day after Judgment
                                            Day»</span>
                                    </li>
                                    <li class="li-product">
                        ...
                        <div class="row sub-para-w3layouts mt-5">
                            ...
                            <p class="mt-3 italic-blue editContent">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/A36LahZNUiE?controls=0" frameborder="0"
                        ...
                        <div class="row">
                            <div class="single-form-left">
                                <div class="contact-single">
                                    <h3 class="editContent">
                                        <span class="sub-tittle editContent">02</span>Оставить отзыв
                                    </h3>
                                ...
                                <div class="media-body mt-4">
                                    ...
                                    <div class="media mt-5 editContent">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mt-0 editContent">Leia Organa
                                            </h5>
                                            <p class="mt-2 editContent"> Cras sit
                                                amet
